...
{% include thumb.html path="2026/01/ss-20260125-01.png" alt="template" %}
...
{% include thumb.html path="2026/01/ss-20260125-02.png" alt="Model links" %}
...
{% include thumb.html path="2026/01/ss-20260125-03.png" alt="workflow" %}
...
{% include thumb.html path="2026/01/ss-20260125-04.png" alt="bypass" %}

これでどちらを bypass するか切り替えて実行する形です。

{% include thumb.html path="2026/01/ss-20260125-05.png" alt="distilled" %}

このようになっていれば、Distilled モデルで生成される形です。


## Base モデルの出力例
{% include thumb.html path="2026/01/ss-20260125-07.png" alt="base" %}

Base モデルで生成すると、こちらの絵が出力されるまで 69.29 秒かかりました。

## Distilled モデルの出力例
{% include thumb.html path="2026/01/ss-20260125-08.png" alt="distilled" %}
